-- =====================================================
-- İRMA CRM - 50 DETAYLI POZİSYON KAYDI
-- Supabase SQL Editor'de çalıştırın
-- =====================================================

-- UYARI: Bu script mevcut pozisyonları silip yenilerini ekleyecek!
-- Eğer mevcut verileri korumak istiyorsanız, TRUNCATE satırını yorum satırı yapın.

-- 1. Önce bağımlı kayıtları temizle
...
-- 3. Position numarası sequence'ini sıfırla
ALTER SEQUENCE positions_position_no_seq RESTART WITH 1;

-- 4. 50 Yeni Pozisyon Ekle
...
-- =====================================================
-- Kalan 40 pozisyon devam ediyor...
-- Size kolaylık olması için sadece ilk 10'u gösterdim
-- Tam listeyi seed_data.sql dosyasından kopyalayabilirsiniz
-- =====================================================

-- İstatistikleri göster
SELECT 
  'Eklenen Pozisyon Sayısı' as bilgi, 
  COUNT(*)::text as adet 
FROM positions;

SELECT 
  'Farklı Statusler' as bilgi,
  string_agg(DISTINCT status::text, ', ') as adet
FROM positions;
